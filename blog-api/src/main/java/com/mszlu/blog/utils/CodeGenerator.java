...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //模块地址
        String modules = "blog-api";
        String Path = "D:\\prog\\work\\mszl\\blog-parent\\blog-api";
        //设置输出文件路径
...
//        gc.setFileOverride(true);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mszl-blog?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        ...
        //模块名称
//        pc.setModuleName(scanner("blog-api"));
        //父包
        pc.setParent("com.mszlu.blog");
        //自定义实体包名(不同的模块自己手动修改)
